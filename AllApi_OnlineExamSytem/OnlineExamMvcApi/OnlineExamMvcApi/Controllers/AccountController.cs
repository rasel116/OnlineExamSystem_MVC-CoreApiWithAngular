...
using OnlineExamMvcApi.Providers;
using OnlineExamMvcApi.Results;
...
namespace OnlineExamMvcApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //{
            ...
            //return Ok();
            //=====================Commented for Angular register======================
            //    if (!ModelState.IsValid)
            //    {
            //        return BadRequest(ModelState);
            //    }
        ...
        [Route("api/ForTeacherOrStudent")]
        public string ForAuthorOrReader()
        {
            return "For Teacher/Student role";
        }
